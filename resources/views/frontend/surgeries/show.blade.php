...
@include('layouts.frontend.includes.page_header',['header'=>$surgery->header_path])
...
<section class="sec-padding">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="primary-color"  style="color:{{ $surgery->category->color }};">{{ $surgery->name }}</h3>
                <div class="pull-right">
                    <img src="{{ $surgery->image_path }}" class="pageImg h-auto" alt="">
                </div>
                <div class="m-t-15"  style="color:{{ $surgery->category->color }};">
                    {!! $surgery->body !!}
                </div> 
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center m-b-25 m-t-25">
                <h3  class="primary-color bold text-center m-b-30 wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.5s"  style="color:{{ $surgery->category->color }};">@lang('site.patients') @lang('site.before_after')</h3>
            </div>
            ...
            <div class="col-md-12 text-center m-t-30">
                <a href="{{ route('frontend.pages.before_after') }}" class="btn btn-site"  style="color:{{ $surgery->category->color }};">@lang('site.view') @lang('site.photo_album')</a>
            </div>
        </div>
    </div>
</section>    
...
<section class="about  sec-padding">
    <div class="container">
        <div class="row sec-padding justify-content-center">
            <div class="col-md-12 text-center m-b-25 m-t-25">
                <h2 class="primary-color"  style="color:{{ $surgery->category->color }};">@lang('site.surgery_expectation')</h2>
            </div>
