            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block" src="Technomasr/images/slide3.jpg" alt="First slide">
                        <div class="carousel-caption">
                            <h2 class="bold primary-color wow flipInY" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                Injection of fillers (fillers)</h2>
                            <div class="desc m-t-30 wow bounceInLeft" data-wow-duration="1.8s" data-wow-delay="1s">
                                <p>
                            ...
                            <a href="#" class="btn btn-site m-t-20 text-white wow flipInY" data-wow-duration="1.5s" data-wow-delay="2.5s">Read More</a>
                        </div>
                    </div> 
                    <div class="carousel-item">
                        <img class="d-block" src="Technomasr/images/slide2.jpg" alt="Second slide">
                        <div class="carousel-caption">
                            <h2 class="bold primary-color wow rotateInDownRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <span>Cosmetic face implants</span>
                            </h2>
                    ...
                    <div class="carousel-item">
                        <img class="d-block" src="Technomasr/images/slide33.jpg" alt="Third slide">
                        <div class="carousel-caption">
                            <h2 class="bold primary-color wow rollIn" data-wow-duration="1.5s" data-wow-delay="0.5s">Injection of fillers (fillers)</h2>
                            <div class="desc m-t-30 wow zoomInLeft" data-wow-duration="1.8s" data-wow-delay="1s">
                                <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                    text ever since the 1500s, when an unknown printer took a galley of type and scrambled
                                    it to make a type specimen book. It has survived not only five centuries, but also the
                            ...
                            <a href="#" class="btn btn-site m-t-20 text-white wow rollIn" data-wow-duration="1.5s" data-wow-delay="2.5s">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image wow fadeIn" data-wow-duration="1.5s" data-wow-delay="1s">
                            <img src="Technomasr/images/about.jpg" alt="about" class="mw-100 h-auto" />
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-4 text-center"> 
                        <div class="serv">
                            <div class="service">
                                <figure>
                                    <img alt src='Technomasr/images/img2.jpg' />
                                </figure>
                            </div>
                            <h3 > <a href="surgeries.php" class="primary-color f-s-25"> Service Type Title</a></h3>  
                        </div>  
                    </div>
                   <div class="col-lg-3 col-md-4 text-center"> 
                        <div class="serv">
                            <div class="service">
                                <figure>
                                    <img alt src='Technomasr/images/img1.jpg' />
                                </figure>
                            </div>
                            <h3 > <a href="surgeries.php" class="primary-color f-s-25"> Service Type Title</a></h3>  
                        </div>  
                    ...
                    <div class=" col-lg-3 col-md-4 text-center"> 
                        <div class="serv">
                            <div class="service">
                                <figure>
                                    <img alt src='Technomasr/images/img3.jpg' />
                                </figure>
                            </div>
                            <h3 > <a href="surgeries.php" class="primary-color f-s-25"> Service Type Title</a></h3>  
                        </div>  
        ...
        <section class="center" >
            <div class="row no-margin">
                <div class="col-md-5 p-0">
                    <img src="Technomasr/images/img5.jpg" class="w-100  h-auto" alt="Cosmatic">
                </div>
                    ...
                    <div class="owl-demo photos-owl-demo wow zoomIn m-b-30" animation-delay="1s" data-wow-delay="0.4s">
                        <div class="item">
                            <a href="#" target="_blank">
                                <img src="Technomasr/images/b-a.jpg" alt="Owl Image">
                            </a>
                        </div>
                        <div class="item">
                            <a href="#" target="_blank">
                                <img src="Technomasr/images/ba1.jpg" alt="Owl Image">
                            </a>
                        </div>
                        <div class="item">
                            <a href="#" target="_blank">
                                <img src="Technomasr/images/ba2.jpg" alt="Owl Image">
                            </a>
                        </div>
                        <div class="item">
                            <a href="#" target="_blank">
                ...
                <div class="owl-demo Videos-owl-demo wow zoomIn m-b-30" animation-delay="1s" data-wow-delay="0.4s">
                    <div class="item text-center">
                       <a data-toggle="modal" data-target="#exampleModal">
                            <iframe  src="https://www.youtube.com/embed/OEgvfUxNYac" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <h4 class="m-t-20 primary-color">Video Title </h6>
                       </a>
                    </div>
                    <div class="item text-center">
                       <a data-toggle="modal" data-target="#exampleModal">
                            <iframe  src="https://www.youtube.com/embed/_J1HpOQo2gA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <h4 class="m-t-20 primary-color">Video Title </h6>
                       </a>
                    </div>
                    <div class="item text-center">
                       <a data-toggle="modal" data-target="#exampleModal">
                            <iframe  src="https://www.youtube.com/embed/b5-GZwJgdrY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <h4 class="m-t-20 primary-color">Video Title </h6>
                       </a>
                    </div>
                    <div class="item text-center">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                <iframe class="w-100 h-auto"  src="https://www.youtube.com/embed/OEgvfUxNYac" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 text-center m-t-30">
                        <a href="videos.php" class="btn btn-site">View More Videos </a>
                    </div>
            </div>
        </section>
                ...
                <div class="owl-demo blog-owl-demo wow zoomIn m-b-30" animation-delay="1s" data-wow-delay="0.4s">
                    <div class="item ">
                        <article class="m-b-30 wow fadeIn" data-wow-duration="1.8s" data-wow-delay="1s">
                            <div class="image">
                                <img src="Technomasr/images/img1.jpg" class="h-auto w-100" alt="">
                            </div>
                            <div class="txt">
                                ...
                                <ul class="p-0 m-t-10">  
                                    <li>
                                        ...
                                        <span>28 july 2018</span>
                                    </li>
                                    <li>
                                        <i class="fa fa-bookmark"></i>
                                        <span>Related Surgery</span>
                                    </li>
                                </ul>
                                <p class="m-t-20">
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                ...
                                <a href="single-blog.php" class="btn btn-site2 pull-right">Read More </a>
                            </div>
                        </article>
                    </div>
                    <div class="item ">
                        <article class="m-b-30 wow fadeIn" data-wow-duration="1.8s" data-wow-delay="1s">
                            <div class="image">
                                <img src="Technomasr/images/img2.jpg" class="h-auto w-100" alt="">
                            </div>
                            <div class="txt">
                                <a href="single-blog.php" class="primary-color primary-color-hover">
                                    What is Lorem Ipsum?
                    ...
                    <div class="item ">
                        <article class="m-b-30 wow fadeIn" data-wow-duration="1.8s" data-wow-delay="1s">
                            <div class="image">
                                <img src="Technomasr/images/img3.jpg" class="h-auto w-100" alt="">
                            </div>
                            <div class="txt">
                                <a href="single-blog.php" class="primary-color primary-color-hover">
                                    What is Lorem Ipsum?
                    ...
                    <div class="item ">
                        <article class="m-b-30 wow fadeIn" data-wow-duration="1.8s" data-wow-delay="1s">
                            <div class="image">
                                <img src="Technomasr/images/img4.jpg" class="h-auto w-100" alt="">
                            </div>
                            <div class="txt">
                                <a href="single-blog.php" class="primary-color primary-color-hover">
                                    What is Lorem Ipsum?
                    ...
                    <div class="item ">
                        <article class="m-b-30 wow fadeIn" data-wow-duration="1.8s" data-wow-delay="1s">
                            <div class="image">
                                <img src="Technomasr/images/img6.jpg" class="h-auto w-100" alt="">
                            </div>
                            <div class="txt">
                                <a href="single-blog.php" class="primary-color primary-color-hover">
                                    What is Lorem Ipsum?
